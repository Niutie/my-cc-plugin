...
> **正确使用流程**：
>
> 1. 走完 [`../CHAPTER-CRAFT.md`](../CHAPTER-CRAFT.md) Part 1 五问
...
> Part 5「整章只用一种入场动画」同质化反模式（每个用户的视频
> 看起来像同一个模板的 N 个变奏）。
...
→ 详细工具箱见 [`../CHAPTER-CRAFT.md`](../CHAPTER-CRAFT.md) Part 3
"视觉工具箱"（CSS / SVG / Canvas / JS 四层）。

### 实测原则

写章节时，**先实现 anchor 同等的地板版本**（按 [`../CHAPTER-CRAFT.md`](../CHAPTER-CRAFT.md)
Part 1 五问选好主导动作），跑起来确认气质对，**再决定要不要加伴随
动作 / 持续微动**。
...
- 如果整章主导动作太单一 = 不要靠"加持续微动"补救，**回 [`../CHAPTER-CRAFT.md`](../CHAPTER-CRAFT.md)
  Part 1 五问换主导动作**才是正解（参 Part 5「整章只用一种入场动画」）
