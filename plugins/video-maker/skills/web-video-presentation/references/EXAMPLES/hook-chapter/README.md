...
口播会**逐个念出来** —— 必须 1 项 = 1 step（[CHAPTER-CRAFT.md Part 0 原则 8 / 逐步揭示](../../CHAPTER-CRAFT.md#逐步揭示禁止一次全展示)）。
